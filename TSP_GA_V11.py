...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  3 20:17:34 2024
...
def adaptive_mutation_rate(current_gen, generations):
    """Dynamically adjust the mutation rate based on the progress of the optimization."""
    initial_mutation_rate = 0.1
    final_mutation_rate = 0.01
    return initial_mutation_rate - ((initial_mutation_rate - final_mutation_rate) * current_gen / generations)
...
def genetic_algorithm(num_cities, pop_size, elite_size, generations):
...
best_route = genetic_algorithm(num_cities, population_size, elite_size, generations)
